...
const AddPositionManagement = () => {
    ...
    return (
        <MainLayout breadcrumb={"Quản lý chức vụ"} title={"Thêm chức vụ"} redirect={ROUTE_PATH.POSITION}>
            ...
            <div className='container-btn main-page bg-white p-4 flex flex-col'>
                <Row justify={"center"}>
                    ...
                    <Col className='mx-1'>
                        <ButtonCommon onClick={onAddPOSITION} classColor="orange">Thêm mới</ButtonCommon>
                    </Col>
                </Row>
            </div >
