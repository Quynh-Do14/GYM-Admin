export const messageConfig = (message) => {
    switch (message) {
        ...
        case "Room is duplicated!":
            return `Bạn đã chọn các phòng trùng nhau, Vui lòng chỉ chọn 1 loại phòng`;
        case "Manager is duplicated!":
            return `Quản lý này đã phụ trách chi nhánh khác. Vui lòng chọn quản lý khách`;
        default:
